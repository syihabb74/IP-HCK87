      ...
      <div className="flex items-center justify-center py-12">
        ...
        <div className="relative z-10 bg-slate-800/90 backdrop-blur-xl rounded-3xl p-12 w-full max-w-md text-center shadow-2xl">
          ...
          <form className="space-y-6 mb-8">
            ...
            <div className="flex items-start gap-2 text-sm">
              <input
                type="checkbox"
                id="terms"
                className="w-4 h-4 text-cyan-400 bg-slate-700 border-slate-600 rounded focus:ring-cyan-400 focus:ring-2 mt-0.5"
                required
              />
              <label htmlFor="terms" className="text-slate-400 cursor-pointer leading-relaxed">
                I agree to the{' '}
          ...
          <div className="flex items-center my-8">
            ...
            <span className="px-6 text-slate-400 text-sm">Or sign up with</span>
            <div className="flex-1 h-px bg-slate-700"></div>
          </div>
          ...
          <div className="text-center">
            <p className="text-slate-400 text-sm">
              ...
              <a href="/login" className="text-cyan-400 hover:text-cyan-300 transition-colors font-semibold">
                Sign In
              </a>
            </p>
          </div>
